...
func domainFor(name string) string {
	...
	case strings.Contains(name, "onboarding") || strings.Contains(name, "boarding_action"):
		return "onboarding"
	case strings.Contains(name, "meeting_template"):
		return "meetings"
...
var commandOverrides = map[string]string{
	...
	"list_meeting_templates":               "list",
	"create_meeting_template":              "create",
	"update_meeting_template":              "update",
	"delete_meeting_template":              "delete",
	"return_training_to_draft":             "return-to-draft",
	"record_lead_custom_field_observation": "record-custom-field-observation",
	"list_lead_custom_field_observations":  "list-custom-field-observations",
